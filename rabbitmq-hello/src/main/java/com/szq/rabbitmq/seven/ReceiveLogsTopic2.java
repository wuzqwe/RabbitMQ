...
public class ReceiveLogsTopic2 {
    ...
    public static void main(String[] args) throws Exception{
        ...
        channel.queueBind(queueName,EXCHANG_NAME,"*.*.rabbit");
        channel.queueBind(queueName,EXCHANG_NAME,"lazy.#");
        System.out.println("等待接收消息....");

        DeliverCallback deliverCallback=(consumerTag, message)->{
            System.out.println("ReceiveLogsTopic2："+new String(message.getBody(),"UTF-8"));
